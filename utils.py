...
RX_ANTENNA_GAIN = 30 # dBi
TX_ANTENNA_GAIN = 40 # dBi
...
def reset():
  ...
  global TOTAL_SLOTS
  global BEAM_RADIUS
  global USER_SWITCHING_THRESHOLD_HEAVY
  global USER_SWITCHING_THRESHOLD_LIGHT
  global TOTAL_BEAM_NUMBER
  global SATELLITE_ALTITUDE
  global CARRIER_FREQUENCY
  global BANDWIDTH
  global RX_ANTENNA_GAIN
  global TX_ANTENNA_GAIN
  global TRANSMIT_POWER
  global USER_WEIGHT_THRESHOLD
  global SUBCHANNEL_NUMBER
  global PACKET_SIZE
  global TIME_SLOT_DURATION
  global RATE_SCALING_FACTOR
  global LAMBDA_1
  global RNG_SEED
  global LOG_LEVEL
  global PLOT_LEVEL
